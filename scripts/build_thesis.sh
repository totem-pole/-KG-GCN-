...
if command -v rsvg-convert >/dev/null 2>&1; then
  ...
  echo "[ERROR] neither rsvg-convert nor inkscape was found."
  exit 1
fi
...
# Work in a disposable copy so tracked semantic source files are never rewritten during compilation.
